...
Daily-updated dataset of available and resale .ca one-word domains from Unique Domains.

> **Note:** this repository currently mirrors the full live catalog for this exact search.
> Unique Domains counts can still change as the search refreshes.

**Public extract:** 4,630 rows · **Live catalog:** 4,627 domains
...
- `ca.csv` — public CSV extract (4,630 rows)
- `ca.json` — public JSON extract (4,630 rows)
...
| forgiving.ca  | resell    | $4,025     | $16.99        | 96             | 6      | 9      | Go Daddy Domains Canada, Inc |
...
| ----------------------- | ------------------------------------------------ |
| 4,630-row public sample | 4,627 live domains                               |
...
> Unique Domains. *Available .CA One-Word Domains*. Version 2026-04-11. Public GitHub extract for the exact Unique Domains search represented by this repository.
